    ...
    public class MainTabWindow_WeaponStats : MainTabWindow
    {
        ...
        private void DoRangedPage(Rect rect, int count, List<RangedWeapon> rangedList)
        {
            ...
            if (!this.ce)
            {
                ...
                var label = "GearStats.ColRange".Translate() + ": ";
                var lsize = Text.CalcSize(label).x;
                Widgets.Label(new Rect(currentX, rect.y + 3, lsize, 30), label);
                currentX += lsize;

                PrintAutoRadio("GearStats.AccRbName.All".Translate(), ref accRbAll, ref currentX, ref rect);
                PrintAutoRadio("GearStats.AccRbName.Touch".Translate(), ref accRbTouch, ref currentX, ref rect);
                PrintAutoRadio("GearStats.AccRbName.Short".Translate(), ref accRbShort, ref currentX, ref rect);
                PrintAutoRadio("GearStats.AccRbName.Medium".Translate(), ref accRbMedium, ref currentX, ref rect);
                PrintAutoRadio("GearStats.AccRbName.Long".Translate(), ref accRbLong, ref currentX, ref rect);
            }
            ...
            printCellSort(WeaponsTab.Ranged, "label", "GearStats.ColName".Translate(), ww, LABEL_WIDTH);
            ww += LABEL_WIDTH;
            foreach (colDef h in rangedHeaders)
            {
                if (h.property == "dpsa")
                {
                    if (accRbAll) printCellSort(WeaponsTab.Ranged, "dpsa", "GearStats.ColDPSA".Translate(), ww, ACCURACY_WIDTH);
                    else if (accRbTouch) printCellSort(WeaponsTab.Ranged, "dpsaTouch", "GearStats.ColDPSA".Translate(), ww, ACCURACY_WIDTH);
                    else if (accRbShort) printCellSort(WeaponsTab.Ranged, "dpsaShort", "GearStats.ColDPSA".Translate(), ww, ACCURACY_WIDTH);
                    else if (accRbMedium) printCellSort(WeaponsTab.Ranged, "dpsaMedium", "GearStats.ColDPSA".Translate(), ww, ACCURACY_WIDTH);
                    else if (accRbLong) printCellSort(WeaponsTab.Ranged, "dpsaLong", "GearStats.ColDPSA".Translate(), ww, ACCURACY_WIDTH);
                }
                else
                {
                    printCellSort(WeaponsTab.Ranged, h.property, ("GearStats.Col" + h.label).Translate(), ww);
                }
            ...
            if (!this.ce)
            {
                if (accRbAll) printCellHeader(WeaponsTab.Ranged, "accuracy", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbTouch) printCellSort(WeaponsTab.Ranged, "accuracyTouch", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbShort) printCellSort(WeaponsTab.Ranged, "accuracyShort", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbMedium) printCellSort(WeaponsTab.Ranged, "accuracyMedium", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbLong) printCellSort(WeaponsTab.Ranged, "accuracyLong", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                ww += ACCURACY_WIDTH;
                ww += DTYPE_WIDTH;
            }
        ...
        private void DoMeleePage(Rect rect, int count, List<MeleeWeapon> meleeList)
        {
            ...
            int ww = GetStartingWidth();
            DrawCommon(-1, inRect.width);
            printCellSort(WeaponsTab.Melee, "label", "GearStats.ColName".Translate(), ww, LABEL_WIDTH);
            ww += LABEL_WIDTH;
            foreach (colDef h in meleeHeaders)
            {
                printCellSort(WeaponsTab.Melee, h.property, ("GearStats.Col" + h.label).Translate(), ww);
                ww += STAT_WIDTH;
            }

            printCell("GearStats.ColType".Translate(), num, ww, DTYPE_WIDTH);
            ww += DTYPE_WIDTH;
            Rect scrollRect = new Rect(rect.x, rect.y - 35, rect.width, rect.height);
            Widgets.BeginScrollView(scrollRect, ref scrollPosition, inRect);
        ...
        private void DoGrenadePage(Rect rect, int count, List<GrenadeWeapon> grenadeList)
        {
            ...
            int ww = GetStartingWidth();
            DrawCommon(-1, inRect.width);
            printCellSort(WeaponsTab.Grenades, "label", "GearStats.ColName".Translate(), ww, LABEL_WIDTH);
            ww += LABEL_WIDTH;
            foreach (colDef h in grenadeHeaders)
            {
                printCellSort(WeaponsTab.Grenades, h.property, ("GearStats.Col" + h.label).Translate(), ww);
                ww += STAT_WIDTH;
            }
        ...
        private void DoOtherPage(Rect rect, int count, List<OtherWeapon> otherList)
        {
            ...
            int ww = GetStartingWidth();
            DrawCommon(-1, inRect.width);
            printCellSort(WeaponsTab.Other, "label", "GearStats.ColName".Translate(), ww, LABEL_WIDTH);
            ww += LABEL_WIDTH;
            foreach (colDef h in otherHeaders)
            {
                printCellSort(WeaponsTab.Other, h.property, ("GearStats.Col" + h.label).Translate(), ww);
                ww += STAT_WIDTH;
            }
        ...
        private void DoApparelPage(Rect rect, int count, List<Apparel> apparelList)
        {
            ...
            int ww = GetStartingWidth();
            DrawCommon(-1, inRect.width);
            printCellSort(WeaponsTab.Apparel, "label", "GearStats.ColName".Translate(), ww, LABEL_WIDTH);
            ww += LABEL_WIDTH;
            foreach (colDef h in apparelHeaders)
            {
                printCellSort(WeaponsTab.Apparel, h.property, ("GearStats.Col" + h.label).Translate(), ww);
                ww += STAT_WIDTH;
            }
        ...
        private void DoTurretsPage(Rect rect, int count, List<Turret> turretList)
        {
            ...
            if (!this.ce)
            {
                if (accRbAll) printCellHeader(WeaponsTab.Turrets, "accuracy", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbTouch) printCellSort(WeaponsTab.Turrets, "accuracyTouch", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbShort) printCellSort(WeaponsTab.Turrets, "accuracyShort", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbMedium) printCellSort(WeaponsTab.Turrets, "accuracyMedium", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                else if (accRbLong) printCellSort(WeaponsTab.Turrets, "accuracyLong", "GearStats.ColAccuracy".Translate(), ww, ACCURACY_WIDTH);
                ww += ACCURACY_WIDTH;
                ww += DTYPE_WIDTH;
            }
            rect.y -= 35;
        ...
        public override void DoWindowContents(Rect rect)
        {
            ...
            list.Add(new TabRecord("GearStats.Ranged".Translate(),
                delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Ranged; }, this.curTab == WeaponsTab.Ranged));
            list.Add(new TabRecord("GearStats.Melee".Translate(),
                delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Melee; }, this.curTab == WeaponsTab.Melee));
            list.Add(new TabRecord("GearStats.Grenades".Translate(),
                delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Grenades; }, this.curTab == WeaponsTab.Grenades));
            list.Add(new TabRecord("GearStats.Apparel".Translate(),
                delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Apparel; }, this.curTab == WeaponsTab.Apparel));
            list.Add(new TabRecord("GearStats.Turrets".Translate(),
                delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Turrets; }, this.curTab == WeaponsTab.Turrets));
            if (Prefs.DevMode && false)
            {
                list.Add(new TabRecord("GearStats.Tools".Translate(),
                    delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Tools; }, this.curTab == WeaponsTab.Tools));
                list.Add(new TabRecord("GearStats.Other".Translate(),
                    delegate { this.curTab = GearStats.MainTabWindow_WeaponStats.WeaponsTab.Other; },
            ...
            {
                PrintAutoCheckbox("GearStats.Ground".Translate(), ref this.showGround, ref currentX, ref rect);
                PrintAutoCheckbox("GearStats.Colonists".Translate(), ref this.showEquipped, ref currentX, ref rect);
                PrintAutoCheckbox("GearStats.Prisoners".Translate(), ref this.showEquippedP, ref currentX, ref rect);
                PrintAutoCheckbox("GearStats.Hostiles".Translate(), ref this.showEquippedH, ref currentX, ref rect);
                PrintAutoCheckbox("GearStats.Friendlies".Translate(), ref this.showEquippedF, ref currentX, ref rect);
                PrintAutoCheckbox("GearStats.Corpses".Translate(), ref this.showEquippedC, ref currentX, ref rect);
                if (weaponStorageLoaded || outfitStorageLoaded)
                {
                    PrintAutoCheckbox("GearStats.Storage".Translate(), ref this.showStorage, ref currentX, ref rect);
                }
            }
            
            PrintAutoCheckbox("GearStats.Craftable".Translate(), ref this.showCraftable, ref currentX, ref rect);
